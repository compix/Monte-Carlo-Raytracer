...
public:
    ...
    */
	...
	void setLookDirection(const glm::vec3& direction, const glm::vec3& worldUp = glm::vec3(0.0f, 1.0f, 0.0f));
    ...
    */
    ...
    bool hasChangedSinceLastFrame() const { return m_changedSinceLastFrame; }
	...
	/**
	* Static entities can't be transformed (translated, scaled, rotated) when the application is running.
	*/
