...
bool Window::init(int oglMajorVersion, int oglMinorVersion)
{
	...
	m_oglMajorVersion = oglMajorVersion;
	m_oglMinorVersion = oglMinorVersion;
...
bool Window::createWindow(bool enableVsync)
{
	...
	if (!m_context)
	{
		LOG_ERROR("Failed to create OpenGL context. Make sure your GPU supports OpenGL " << m_oglMajorVersion << "." << m_oglMinorVersion);

		std::stringstream ss;
		ss << "Failed to create OpenGL context. Make sure your GPU supports OpenGL " << m_oglMajorVersion << "." << m_oglMinorVersion;
