...
void Downsampler::downsampleOpacity(Texture3D* texture, const std::vector<VoxelRegion>* clipRegions, int clipmapLevel)
{
    ...
    m_downsampleOpacityShader->setInt("u_downsampleTransitionRegionSize", VCT::GI_SETTINGS.downsampleTransitionRegionSize);
...
void Downsampler::downsample(Texture3D* image, const std::vector<VoxelRegion>* clipRegions)
{
    ...
    {
        m_downsampleShader->setInt("u_downsampleTransitionRegionSize", VCT::GI_SETTINGS.downsampleTransitionRegionSize);
