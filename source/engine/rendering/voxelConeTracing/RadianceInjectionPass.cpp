...
void RadianceInjectionPass::injectByVoxelization(Shader* shader, Texture3D* voxelRadiance, VoxelizationMode voxelizationMode)
{
    ...
    desc.downsampleTransitionRegionSize = VCT::GI_SETTINGS.downsampleTransitionRegionSize;
    ...
    ECSUtil::setDirectionalLightUniforms(shader, shadowMapStartTextureUnit, VCT::GI_SETTINGS.radianceVoxelizationPCFRadius);
...
{
    switch (VCT::GI_SETTINGS.radianceInjectionMode)
    {
    case 0:
