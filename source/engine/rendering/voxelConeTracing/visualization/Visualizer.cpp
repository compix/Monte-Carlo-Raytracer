    ...
    bool hasPrevLevel, bool hasMultipleFaces, int numColorComponents)
{
    ...
    m_voxelVisualizationShader->setFloat("u_alpha", VCT::VISUALIZATION_SETTINGS.voxelVisualizationAlpha);
    m_voxelVisualizationShader->setFloat("u_borderWidth", VCT::VISUALIZATION_SETTINGS.borderWidth);
    m_voxelVisualizationShader->setVector("u_borderColor", VCT::VISUALIZATION_SETTINGS.borderColor);
                                                 ...
                                                 VoxelRegion prevRegion, bool hasPrevLevel, bool hasMultipleFaces, int numColorComponents)
{
    ...
    m_voxelFaceVisualizationShader->setFloat("u_alpha", VCT::VISUALIZATION_SETTINGS.voxelVisualizationAlpha);
    m_voxelFaceVisualizationShader->setFloat("u_borderWidth", VCT::VISUALIZATION_SETTINGS.borderWidth);
    m_voxelFaceVisualizationShader->setVector("u_borderColor", VCT::VISUALIZATION_SETTINGS.borderColor);
...
void Visualizer::visualize3DTexture(GLuint texture, const glm::vec3& position, uint32_t visualizeClipNum, float padding, float texelSize) const
{
    ...
    m_textureVisualizationShader->setFloat("u_alpha", VCT::VISUALIZATION_SETTINGS.voxelVisualizationAlpha);
    m_textureVisualizationShader->setFloat("u_borderWidth", VCT::VISUALIZATION_SETTINGS.borderWidth);
    m_textureVisualizationShader->setVector("u_borderColor", VCT::VISUALIZATION_SETTINGS.borderColor);
