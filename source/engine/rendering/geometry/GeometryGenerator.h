...
public:
	...
	static MeshData createTriangle(const glm::vec3& pos0, const glm::vec3& pos1, const glm::vec3& pos2);

	/**
	* Normal of the disk is the z-axis.
	*/
	static MeshData createDisk(float radius, GLuint sliceCount);
};
