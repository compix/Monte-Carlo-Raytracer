...
public:
	...
	static void drawDisk(const glm::vec3& pos, float radius = 1.0f, const glm::vec4& color = glm::vec4(0.5f,0.5f,0.5f,1.0f), float duration = 0.0f);
...
private:
	...
	static std::shared_ptr<MeshRenderer> m_diskMeshRenderer;
