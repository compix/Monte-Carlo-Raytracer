...
public:
	...
	TextureID getGLID() const noexcept { return m_glId; }
    ...
    void load(const std::string& path, Texture2DSettings settings = Texture2DSettings::S_T_REPEAT_MIN_MAG_LINEAR, bool keepImageData = true);
	...
	int getNumMipmapLevels() const { return m_numMipmapLevels; }
